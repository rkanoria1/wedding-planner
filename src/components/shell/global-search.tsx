        ...
        <DialogContent className="top-24 translate-y-0 gap-0 p-0 sm:max-w-lg">
          ...
          <div className="flex items-center gap-2 border-b px-4">
            ...
            <Input
              ...
              placeholder="Search tasks, guests, vendors, shopping, events…"
